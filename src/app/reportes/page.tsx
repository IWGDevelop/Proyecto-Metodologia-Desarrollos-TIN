...
export default function ReportesPage() {
  ...
  const handleExportarCompleto = () => {
    if (!datos.length) {
      toast.error('Sin datos en el período seleccionado')
      return
    }
    try {
  ...
  return (
    <div className="space-y-6 p-5">
      ...
      {/* Separadores entre reportes */}
      <div className="space-y-10">
        <section>
          <ReporteImpactoEconomico datos={datos} isLoading={isLoading} />
        </section>

        <div className="border-t border-slate-200" />

        <section>
          <ReporteRespuestaTIN datos={datos} isLoading={isLoading} />
        </section>

        <div className="border-t border-slate-200" />

        <section>
          <ReporteDesarrollo datos={datos} isLoading={isLoading} />
        </section>

        <div className="border-t border-slate-200" />

        <section>
          <ReportePruebas datos={datos} isLoading={isLoading} />
        </section>

        <div className="border-t border-slate-200" />

        <section>
          <ReporteStandBy datos={datos} isLoading={isLoading} />
        </section>

        <div className="border-t border-slate-200" />

        <section>
          <ReporteProductividad datos={datos} isLoading={isLoading} />
        </section>
      </div>
    </div>
  )
